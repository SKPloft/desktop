...
export default function HistoryRow({ h, compact, drawer }: any) {
  ...
  return (
    <li
      key={h.id}
      className={cn(
        "relative flex justify-between gap-x-6 px-4 py-5 hover:bg-gray-50 dark:hover:bg-content2 sm:px-6",
        { "py-5": !compact },
        { "py-1": compact },
      )}
    >
      <div className="flex min-w-0 gap-x-4">
        ...
        <div className="min-w-0 flex-col justify-center truncate">
          <Highlight theme={theme} code={h.command} language="bash" prism={Prism}>
      ...
      <div className="flex shrink-0 items-center gap-x-4">
        ...
        {drawer && (
          ...
          >
            <HistoryInspect history={h} theme={theme} />
          </Drawer>
        )}
      </div>
    </li>
