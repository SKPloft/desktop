                  ...
                  <div className="h-ful relative flex items-center">
                    ...
                    {stepIdx < steps.length - 1 && !hideProgressBars && (
                      ...
                      >
                        <div
                          className={cn(
                            "relative h-0.5 w-full bg-default-200 transition-colors duration-300 after:w-full",
                            "before:absolute before:block before:h-full before:w-0 before:bg-[var(--active-border-color)] before:transition-[width] before:duration-300 before:content-['']",
                            {
                              "before:w-full": stepIdx < currentStep,
                            },
                          )}
                        />
                      </div>
