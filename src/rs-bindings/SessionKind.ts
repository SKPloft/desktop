...
export type SessionKind =
  | { type: "assistantChat"; data: { runbook_id: string; block_infos: Array<BlockInfo> } }
  | {
      type: "inlineBlockGeneration";
      data: {
        runbook_id: string;
        block_infos: Array<BlockInfo>;
        current_document: JsonValue;
        /**
         * The ID of the block after which to insert the new blocks;
         * this is the block where the user pressed Cmd/Ctrl+Enter.
         */
        insert_after: string;
        is_initial_generation: boolean;
      };
    };
